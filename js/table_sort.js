...
// Added module OneForAll localisations vars
// txt_sort_by1, txt_sort_by2, txt_sort_table
...
( function() {	
	...
	document.head.appendChild(JB_sortbutStyle);
		...
		var initTableHead = function(t,nr) {
			...
			b.title = txt_sort_by1+' "'+b.textContent+'"'+txt_sort_by2+'.';
			t.appendChild(b);
...
//			return val.toLowerCase().replace(/\u00e4/g,"ae").replace(/\u00f6/g,"oe").replace(/\u00fc/g,"ue").replace(/\u00df/g,"ss");
		...
		if(!tab.title.length) tab.title=txt_sort_table;
